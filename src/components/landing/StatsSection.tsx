        ...
        <section className="border-y-brutal border-border bg-mint px-4 py-14 md:px-6">
            <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-3">
                {stats.map((stat) => (
                    <article
                        key={stat.label}
                        className="border-brutal border-border bg-card px-6 py-8 text-center shadow-brutal transition duration-150 hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-brutal-lg"
                    >
