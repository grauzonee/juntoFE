...
export default function LandingCta() {
    return (
        <section className="relative overflow-hidden border-b-[3px] border-border bg-yellow px-4 py-20 text-center md:px-6">
            <div className="absolute left-[8%] top-10 h-10 w-10 rounded-full border-[3px] border-border" />
            <div className="absolute bottom-10 left-[15%] h-5 w-5 rotate-[-12deg] border-2 border-border bg-mint" />
            <div className="absolute right-[10%] top-14 h-7 w-7 rotate-[15deg] border-[3px] border-border" />
